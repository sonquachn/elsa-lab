...
resource "aws_iam_role_policy_attachment" "node_k8s-autoscaling" {
  policy_arn = "arn:aws:iam::586025297977:policy/k8s-autoscaling"
  role       = aws_iam_role.node.name
}
